...
df_short <- crimes %>% select(Date, "Community Area", IUCR, "FBI Code") # Select desired columns
df_short <- df_short %>% rename(Community_Area = "Community Area", FBI_Code = "FBI Code")
