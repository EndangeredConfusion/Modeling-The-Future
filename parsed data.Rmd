...
ggplot(data=crimes_by_day_frame, aes(x = day, y = crimes_by_day)) +
  geom_bar(stat="identity") + geom_text(aes(label = day_name), vjust = 1.5, colour = "white") + geom_text(aes(label = crimes_by_day), vjust = 3.5, colour = "white")
...
ggplot(data=crimes_by_month_frame, aes(x = months, y = crimes_by_month)) +
  geom_bar(stat="identity") + geom_text(aes(label = month_name), vjust = 1.5, colour = "white") + geom_text(aes(label = crimes_by_month), vjust = 3.5, colour = "white")
```
